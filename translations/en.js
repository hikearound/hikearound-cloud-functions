exports.translations = {
    ...
    notif: {
        digest: {
            ...
            body: 'Get ready for the weekend by checking out {{name}} and other hikes we think you might like',
        },
        reviewLike: {
            title: 'Liked by {{name}}',
    ...
    email: {
        common: {
            footer: {
                intro: 'This email was sent by Hikearound (542 Brannan St, San Francisco, CA 94107). ',
                type: 'To stop receiving {{type}} emails, <a class="text-link" href="{{url}}">Click here</a>. ',
                global: 'To stop receiving this and all other emails, <a class="text-link" href="{{url}}">Unsubscribe</a>.',
            },
        },
        digest: {
            subject:
                'Get ready for the weekend by checking out {{name}} and other hikes we think you might like.',
            body: 'Hi {{name}},<br>We recently added some hikes near {{location}} and this is one we think you might enjoy.',
            description:
